...
ggplot(
  ...
  mapping = aes(
    ...
    color=sexe,
    fill=sexe)
) + labs(x = "handlengte", y = "count", title = "Verdeling van de handlengte onder mannen en vrouwen") +
  geom_vline(
      data=mu_handlengte,
      aes(
        xintercept=grp.mean, 
...
ggplot(
  ...
  mapping = aes(
    ...
    color=sexe,
    fill=sexe)
) + labs(x = "handbreedte", y = "count", title = "Verdeling van de handbreedte onder mannen en vrouwen") +
  geom_vline(
      data=mu_handbreedte,
      aes(
        xintercept=grp.mean, 
...
ggplot(data = biometric_data,
    ...
    geom_boxplot() +
    geom_point() +
    labs(x = "Sexe", y = "handlengte", title = "Verdeling van handlengte onder mannen en vrouwen") +  
    theme_minimal() 
...
ggplot(data = biometric_data,
    ...
    facet_wrap(. ~ sexe) +                       
    labs(x = "lengte/breedte ratio", y = "count", title = "Verdeling van de lengte breedte ratio onder mannen en vrouwen") +
    theme_minimal()

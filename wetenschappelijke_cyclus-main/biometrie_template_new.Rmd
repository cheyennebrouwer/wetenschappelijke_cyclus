...
4.  Welke minimale `n` geeft het meeste kans om een echte normaalverdeling te zien?
    ...
    -\> Over het algemeen wordt er vanuit gegaan dat een steekproefgrootte van minimaal 30 (n=30) representatief is en dus een echte normaalverdeling weergeeft. Dit wordt ook wel de regel van steekproefomvang 30 genoemd. 
